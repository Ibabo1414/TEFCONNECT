...
return this;};jQuery(document).ready(function($){var show=reader_customscript.show;var icon=reader_customscript.icon;if(show==='1'){jQuery("body").prepend("<a id='move-to-top' class='animate ' href='#blog'><i class='fa fa-"+icon+"'></i></a>");var scrollDes='html,body';if(navigator.userAgent.match(/opera/i)){scrollDes='html';}
...
scrollToAnchor(target,event);}});});if(reader_customscript.responsive&&reader_customscript.nav_menu!='none'){jQuery(document).ready(function($){$('#primary-navigation').append('<div id="mobile-menu-overlay" />');if(reader_customscript.nav_menu=='both'&&!$('.navigation.mobile-only').length){$('.navigation').not('.mobile-menu-wrapper').find('.menu').clone().appendTo('.mobile-menu-wrapper').hide();}
